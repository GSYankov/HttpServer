...
namespace IRunesWebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            bool isUserCreated = this.usersService.CreateUser(model);
        ...
        //    {
        //        return new BadRequestResult("Please provide valid username with length of 4 or more characters.",SIS.HTTP.Enums.HttpResponseStatusCode.SeeOther);
        //    }
